...
![Instance list with the Create Snapshot button](images/um_create_instance_snapshot.png)
...
![Images list showing the new instance snapshot](images/um_list_snapshot.png)
...
![Launch Instance Source tab with Instance Snapshot as the boot source](images/um_launch_instance_from_snapshot.png)
...
![Instance list showing the restored instance in Active status](images/um_successful_instance_restore.png)
...
![Volume list drop-down menu with the Create Backup option](images/um_create_volume_backup.png)

Fill out the following form with at least the name of the backup and any
other fields needed.

![Create Volume Backup form with the backup name filled in](images/um_create_volume_backup_form.png)
...
![Volume backups list showing the backup with Available status](images/um_volume_backup_list.png)
...
![Volume backups list confirming the backup exists](images/um_confirm_volume_backup_list.png)
...
![Restore Volume Backup form with the Create a New Volume option](images/um_restore_volume_backup.png)
