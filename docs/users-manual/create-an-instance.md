...
![Key Pairs page in Horizon with the Create Key Pair button](images/um_ssh_key_pairs_horizon.png)
...
![Create Key Pair form with fields for key pair name and type](images/um_create_ssh_keypair_form.png)
...
![Import Public Key form with name, key type, and public key fields](images/um_import_ssh_key_form.png)
...
![Key Pairs list showing the uploaded key pair](images/um_ssh_key_pairs_list.png)
...
![Security Groups page in Horizon](images/um_list_security_groups.png)

**Step 2** -- Create SSH security group

![Create Security Group form with name and description fields](images/um_create_security_group_form.png)
...
![Security group rules list showing two default egress rules](images/um_modify_security_group_form.png)
...
![Add Rule form for a security group](images/um_sec_group_add_rule_form.png)
...
![Security group rules list with the new SSH ingress rule](images/um_modify_security_group_form_new_rule.png)
...
![Volumes page in Horizon](images/um_list_volumes.png)
...
![Create Volume form with name and size fields](images/um_create_a_volume.png)
...
![Volume list showing the new volume with Available status](images/um_volume_listing.png)
...
![Instances page in Horizon](images/um_list_instance.png)

**Step 2** -- Launch Instance -\> Details

Next, use **Launch Instance** near the top right, which loads this form:

![Launch Instance form Details tab with name and count fields](images/um_instance_form_1.png)
...
![Launch Instance Source tab with Image selected as the boot source](images/um_instance_form_2.png)
...
![Launch Instance Flavor tab with a flavor allocated](images/um_instance_form_3.png)
...
![Launch Instance Networks tab with a private network allocated](images/um_instance_form_4.png)
...
![Launch Instance Security Groups tab with the SSH group applied](images/um_instance_form_5.png)
...
![Launch Instance Key Pair tab with an SSH key pair allocated](images/um_instance_form_6.png)
...
![Instance list showing the instance spawning](images/um_instance_listing.png)
...
![Instance list showing Active status and Running power state](images/um_instance_listing_2.png)
...
![Instance list drop-down menu with the Associate Floating IP option](images/um_instance_listing_floating_ip.png)
