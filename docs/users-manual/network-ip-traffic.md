...
![Project and Identity tabs in Horizon's left sidebar](images/um_project_identity.png)
...
![Networks page in Horizon with the Create Network button](images/um_network_networks.png)

-----

**Step 2** -- Create network

![Create Network form with the network name filled in](images/um_create_a_network_form.png)
...
![Subnet tab of the Create Network form with name and network address](images/um_create_a_subnet_form.png)
...
![Network list showing the new network-1 network](images/um_network_listing.png)
...
![Routers page in Horizon with the Create Router button](images/um_router_main_page.png)

**Step 2** -- Create a router

![Create Router form with name and external network fields](images/um_create_router.png)
...
![Router list showing the new router-1 router](images/um_router_list.png)
...
![Router detail page with the Add Interface button](images/um_add_interface_router.png)
...
![Add Interface form with subnet and IP address fields](images/um_router_add_interface.png)
...
![Network Topology page showing router-1 connecting External and network-1](images/um_network_topology.png)
...
![Floating IPs page in Horizon](images/um_floating_ips.png)

Click **Allocate IP To Project** to allocate a new IP.

Next, fill out needed details in the IP allocation form.

![Allocate Floating IP form with the External pool selected](images/um_allocate_floating_ip.png)
...
![Floating IP list showing the newly allocated IP](images/um_floating_ip_listing.png)
