...
![Flavors list in Horizon](images/flavor-list.png "List of Flavors")

**Figure 1**: List of Flavors

Click **Create Flavor** to create a new flavor.

![Create Flavor form](images/flavor-create.png "Create Flavor Form")

**Figure 2**: Create Flavor Form

Fill out the details as needed and submit the form.

![Newly created flavor shown in the list](images/newly-created-flavor-list.png "Newly Created Flavor Listed")
...
![Update Metadata option in the flavor drop down](images/flavor-update-metadata.png "Update Flavor Metadata")
...
![Delete Flavor drop down option](images/delete-flavor.png "Delete Flavor")
