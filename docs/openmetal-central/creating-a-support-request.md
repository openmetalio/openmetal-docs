...
sidebar_position: 3
image: /img/openmetal-central/request2.png
---
...
![OpenMetal Central](/img/openmetal-central/request1.png)

Click **_Support_** in the top right of the home page.

![OpenMetal Central Support from Home](/img/openmetal-central/request7.png "OpenMetal Central Support from Home")

Under **_Start Here_**, click the middle Icon titles **_New Request_**

![OpenMetal Central Support Page](/img/openmetal-central/request12.png "OpenMetal Central Support Page")

You will get a pop-up form that you can use to outline the details of your
request.

![OpenMetal Central Request Form](/img/openmetal-central/request6.png "OpenMetal Central Request Form")

Through the **_Type_** drop-down, you can choose if you need **_Help_** or want
to give **_Feedback._**

![OpenMetal Central Request Type Drop-Down](/img/openmetal-central/request8.png "OpenMetal Central Request Type Drop-Down")
...
![OpenMetal Central Priority Drop-Down](/img/openmetal-central/request5.png)

After you have populated the form, click _Send._ You will get a pop-up
confirmation.

![OpenMetal Central Request Confirmation](/img/openmetal-central/request9.png)
...
![OpenMetal Central View Support Requests](/img/openmetal-central/request11.png)

Likewise, if you are in your Personal Profile you can click Requests on the
left menu

![OpenMetal Central Requests from Personal Profile](/img/openmetal-central/request10.png)

The **_Requests_** page enables you to see all of your support requests in one
place and see their status.

![OpenMetal Central Requests Page](/img/openmetal-central/request3.png)
...
![OpenMetal Central Request Detail](/img/openmetal-central/request4.png)
