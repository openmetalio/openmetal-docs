...
<header className="om-hero">
  <span className="om-hero__mark om-hero__mark--tl" aria-hidden="true"></span>
  <span className="om-hero__mark om-hero__mark--tr" aria-hidden="true"></span>
  <span className="om-hero__mark om-hero__mark--bl" aria-hidden="true"></span>
  <span className="om-hero__mark om-hero__mark--br" aria-hidden="true"></span>
  <div className="om-hero__content">
    <div className="om-hero__meta"><span className="om-hero__dot"></span>OPENMETAL&nbsp;&nbsp;/&nbsp;&nbsp;DOCUMENTATION</div>
    <h1 className="om-hero__title">Private clouds,<br/>fully <em>documented</em>.</h1>
    <p className="om-hero__lead">Resources, guides, and tutorials for getting the most out of OpenMetal’s platform — from first boot to cluster-wide operations.</p>
  </div>
</header>
...
<a className="om-card" href="./operators-manual/">
  ...
  <div className="om-card__cta"><span>Open manual</span><span className="om-arrow" aria-hidden="true">→</span></div>
</a>
...
<footer className="om-landing-footer">
  <span className="om-landing-footer__prompt">$</span>
  <span>Need help? Reach out to our <a href="mailto:support@openmetal.io">support team</a> — let’s build together.</span>
</footer>
