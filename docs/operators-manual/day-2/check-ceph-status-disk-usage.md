...
1.  [Prerequisites](operators_manual/day-2/check-ceph-status-disk-usage.rst#prerequisites)
2.  [Check Ceph
    Status](operators_manual/day-2/check-ceph-status-disk-usage.rst#check-ceph-status)
3.  [Check Ceph Disk
    Usage](operators_manual/day-2/check-ceph-status-disk-usage.rst#check-ceph-disk-usage)
