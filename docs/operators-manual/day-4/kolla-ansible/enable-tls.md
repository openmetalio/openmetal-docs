...
1.  [Prerequisites](operators_manual/day-4/kolla-ansible/enable-tls.rst#prerequisites)

2.    - [Specify an External Fully Qualified Domain Name for
        Horizon](operators_manual/day-4/kolla-ansible/enable-tls.rst#specify-an-external-fully-qualified-domain-name-for-horizon)
        
        1.  [Determine Public
            IP](operators_manual/day-4/kolla-ansible/enable-tls.rst#determine-public-ip)
        2.  [Configure an
            FQDN](operators_manual/day-4/kolla-ansible/enable-tls.rst#configure-an-fqdn)
        3.  [Apply Configuration Change Using Kolla
            Ansible](operators_manual/day-4/kolla-ansible/enable-tls.rst#apply-configuration-change-using-kolla-ansible)

3.    - [Enable SSL Externally, Encrypting Horizon
        Traffic](operators_manual/day-4/kolla-ansible/enable-tls.rst#enable-ssl-externally-encrypting-horizon-traffic)
        
        1.  [Modify Kolla Ansible
            Configuration](operators_manual/day-4/kolla-ansible/enable-tls.rst#modify-kolla-ansible-configuration)
        2.  [Configure Root CA
            Bundle](operators_manual/day-4/kolla-ansible/enable-tls.rst#configure-root-ca-bundle)
        3.  [Prepare SSL
            File](operators_manual/day-4/kolla-ansible/enable-tls.rst#prepare-ssl-file)
        4.  [Specify SSL
            Certificate](operators_manual/day-4/kolla-ansible/enable-tls.rst#specify-ssl-certificate)
        5.  [Enable External
            TLS](operators_manual/day-4/kolla-ansible/enable-tls.rst#enable-external-tls)
        6.  [Reconfigure Cloud using Kolla
            Ansible](operators_manual/day-4/kolla-ansible/enable-tls.rst#reconfigure-cloud-using-kolla-ansible)

4.    - [Reconfigure Ceph Cluster using Ceph
        Ansible](operators_manual/day-4/kolla-ansible/enable-tls.rst#reconfigure-ceph-cluster-using-ceph-ansible)
        
        1.  [Procedure](operators_manual/day-4/kolla-ansible/enable-tls.rst#procedure)

5.  [Reference](operators_manual/day-4/kolla-ansible/enable-tls.rst#reference)
...
## Prerequisites
  ...
  - **Prepare Ceph Ansible**: This guide makes use of Ceph Ansible to
    ...
    Ansible](operators_manual/day-4/ceph-ansible/ceph-ansible.rst). The
...
environment](operators_manual/day-4/ceph-ansible/ceph-ansible.rst).
