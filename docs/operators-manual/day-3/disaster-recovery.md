...
1.    - [Disaster Recovery
        Strategies](operators_manual/day-3/disaster-recovery.rst#disaster-recovery-strategies)
        
        1.  [Recovery
            Objectives](operators_manual/day-3/disaster-recovery.rst#recovery-objectives)
        2.  [Off-site
            Backups](operators_manual/day-3/disaster-recovery.rst#off-site-backups)
        3.  [RBD Mirroring with
            Ceph](operators_manual/day-3/disaster-recovery.rst#rbd-mirroring-with-ceph)

2.    - [Handling a Hardware
        Failure](operators_manual/day-3/disaster-recovery.rst#handling-a-hardware-failure)
        
        1.  [Determine Hardware Node
            Failure](operators_manual/day-3/disaster-recovery.rst#determine-hardware-node-failure)
        2.  [Cluster
            Failure](operators_manual/day-3/disaster-recovery.rst#cluster-failure)

3.  [Cloud Monitoring with
    Datadog](operators_manual/day-3/disaster-recovery.rst#cloud-monitoring-with-datadog)

4.  [Contact
    Support](operators_manual/day-3/disaster-recovery.rst#contact-support)

5.  [Additional
    Reading](operators_manual/day-3/disaster-recovery.rst#additional-reading)
