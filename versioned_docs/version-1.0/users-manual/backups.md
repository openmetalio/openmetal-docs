...
![image](/img/users-manual/um_create_instance_snapshot.png)
...
![image](/img/users-manual/um_list_snapshot.png)
...
![image](/img/users-manual/um_launch_instance_from_snapshot.png)
...
![image](/img/users-manual/um_successful_instance_restore.png)
...
![image](/img/users-manual/um_create_volume_backup.png)

Fill out the following form with at least the name of the backup and any
other fields needed.

![image](/img/users-manual/um_create_volume_backup_form.png)
...
![image](/img/users-manual/um_volume_backup_list.png)
...
![image](/img/users-manual/um_confirm_volume_backup_list.png)
...
![image](/img/users-manual/um_restore_volume_backup.png)
