...
![List of images in the Horizon dashboard Images tab](images/image-list.png)
...
![Create Image button on the Images page in Horizon](images/create-image.png)

**Figure 2:** Creating an Image Within Horizon Dashboard

![Create Image form with name, file, and format fields](images/create-image-form.png)
...
![CirrOS image shown in the Horizon Images tab](images/cirros-uploaded.png)
...
![Create Snapshot button in the instance Actions column](images/create-instance-snapshot.png)
