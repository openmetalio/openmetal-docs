...
![Networks page in Horizon](images/networks.png)
...
![Network tab of the Create Network form](images/network-form.png)
...
![Subnet tab of the Create Network form](images/network-form-subnet.png)
...
![Subnet Details tab with DHCP enabled](images/network-form-subnet-details.png)
...
![Network list showing the new Private network](images/network-list.png)
...
![Routers page in Horizon](images/routers.png)
...
![Create Router form in Horizon](images/router-form.png)
...
![Router list showing the newly created router](images/router-list.png)
...
![Router details page with the Overview tab selected](images/router-details.png)

**Figure 9:** Router Details

![Add Interface form with subnet selection](images/attach-interface.png)
...
![Interfaces tab listing private-subnet](images/private-subnet-interface.png)
...
![Network topology showing connected networks](images/network-topology.png)
...
![Security Groups page with default group](images/security-groups.png)
...
![Create Security Group form](images/security-group-form.png)
...
![Manage Security Group Rules page for SSH](images/add-security-group-rule.png)
...
under your cloud's
[Assets Page](../intro-to-openmetal-private-cloud#how-to-view-your-hardware-assets).
...
![Add Rule form with SSH rule and CIDR set](images/add-ssh-rule.png)
...
![Instances page in Horizon](images/instances.png)
...
![Details tab of the Launch Instance form](images/instance-details.png)
...
![Source tab of the Launch Instance form](images/instance-source.png)
...
![Flavor tab of the Launch Instance form](images/instance-flavor.png)
...
![Networks tab of the Launch Instance form](images/instance-networks.png)
...
![Security Groups tab with SSH selected](images/instance-security-groups.png)
...
![Key Pair tab of the Launch Instance form](images/instance-key-pair.png)
...
![Import Key Pair form in Horizon](images/instance-import-key-pair.png)
...
![Instance list with the Jumpstation instance](images/instance-list.png)
...
![Floating IPs page in Horizon](images/floating-ips.png)
...
![Allocate Floating IP form](images/allocate-floating-ip.png)
...
![Associate button in the floating IP list](images/associate-floating-ip.png)

**Figure 27:** Associate Floating IP

![Floating IP association form](images/manage-floating-ip-associations.png)
